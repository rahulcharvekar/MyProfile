    ...
    <div class="flex-grow p-1">
        <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            <div class="col-span-4 sm:col-span-3">
                <div class="overflow-auto scrollbar-thin bg-white shadow rounded-lg p-4">
                    ...
                    <div class="flex justify-center items-center gap-2 my-2">
                        ...
                        <a class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds Instagram" href="https://www.instagram.com/rahulcharvekar"
                            target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-5">
                                <path fill="currentColor"
